...
var Book = /*#__PURE__*/function (_Model) {
  ...
  _createClass(Book, null, [{
    ...
    value: function init(sequelize) {
      return _get(_getPrototypeOf(Book), "init", this).call(this, {
        id: {
          type: _sequelize.DataType.UUID,
          primaryKey: true,
          alllowNull: false,
          autoIncrement: true,
          defaultValue: _sequelize.DataType.UUIDV4
        },
        title: _sequelize.DataTypes.STRING,
        author: _sequelize.DataTypes.STRING,
        collection: _sequelize.DataTypes.STRING
      }, {
        sequelize: sequelize,
        modelName: 'Book'
      });
...
Book.init(_database["default"].sequelize);
var _default = Book;
