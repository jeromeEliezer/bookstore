...
var UnauthorizedError = /*#__PURE__*/function (_Error) {
  ...
  function UnauthorizedError(message, description) {
    var _this;
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(_assertThisInitialized(_this), UnauthorizedError);
    }

    _this.name = "UnauthorizedError";
    _this.status = _StatusCode.UNAUTHORIZED;
